...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    if num_rolls == 0:
        ...
        return int(roll_dice(num_rolls, dice))
...
def play(strategy0, strategy1, score0=0, score1=0, dice=always_three,
    ...
    while score0 < goal and score1 < goal:
        i, k, roll = score0, score1, 0
        if player == 0:
            if strat0 == 0:
                    score0 += free_bacon(score1)
                    print("bacon: ", roll, score0, score1)
            else:
                while i < goal:
                    score0 += take_turn(strat0, score1, dice)
                    print("0roll: ", roll, score0, score1)
                    i = score0
            swap_score()
        ...
        ## P1 ####======================
            ...
            if strat1 == 0:
                ...
                while k < goal:
                    ...
                    print("1roll: ", roll, score0, score1)               
                    k = score1
            swap_score()
            if score0 >= goal or score1 >= goal:
                break
