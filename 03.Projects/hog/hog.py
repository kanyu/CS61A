...
fix_sided = make_test_dice(4, 6, 1)
counted_dice = make_test_dice(4, 1, 2, 6)
always_three = make_test_dice(3)


def roll_dice(num_rolls, dice=six_sided):#, player_score=0):
...
#    print("T == Ts === Ps")
    while n < num_rolls:# and player_score < GOAL_SCORE:
        r_score = dice()
        if r_score != 1:
            turn_score += r_score
#            player_score += r_score
        elif r_score == 1:
            have1 = True
            turn_score = 1
#            player_score += 1
        n += 1
#        print(n,"  .", turn_score, "===", player_score)
    if have1:
        turn_score = 1
        return turn_score
    else:
...
def free_bacon(score):
    ...
    bacon = 0
    if score >= 10:
        bacon = 2 + abs((score % 10) - (score // 10))
#        print("you have free bacon: +", bacon)
        return bacon
    else:
        bacon = 2 + int(score)
#        print("you have free bacon: +", bacon)
...
def take_turn(num_rolls, opponent_score, dice=six_sided):#, player_score=0):
...
#    assert opponent_score < GOAL_SCORE, 'The game should be over.'
    ...
    "*** YOUR CODE HERE ***"
    if num_rolls == 0:
        return int(free_bacon(opponent_score))
    else:
        return int(roll_dice(num_rolls, dice))#, player_score))
...
#    score_holder = 0
    ##### SWAP SCORE
#    def swap_score():
#        nonlocal score0, score1, score_holder
#        if is_swap(score0, score1):
#            score_holder = score0
#            score0 = score1
#            score1 = score_holder
#            print("swapped", score0, "<--->", score1)
...
#        say_scores(score0, score1)  # call "say", and then "say" becomes the new commentary function
#    luotchoi = 1
#    while score0 < goal and score1 < goal:
#        strat0 = strategy0(score0, score1)
#        strat1 = strategy1(score1, score0)
##        print("--------------------------------------------------------")
##        print("START TURN", luotchoi, ": ", "p0 :", strat0, "--- p1 :", strat1)
##        print("P1 SCORE ================")
#    ######## PLAYER 0 FIRST ###################################
#
##        if player == 0:
...
#        else:
#            score0 += take_turn(strat0, score1, dice)#, score0)
##        print("         score0--:",score0)
#        swap_score()
...
#        else:
#            score1 += take_turn(strat1, score0, dice)#, score1)
##        print("         score1--:", score1)
#        swap_score()
#        if score0 >= goal or score1 >= goal:
#            break
##        print("END TURN", luotchoi, ": s0---s1 :", score0, "---", score1)
##        print("--------------------------------------------------------")        
#        luotchoi += 1
